...
Meeting held monthly on the second Thursday of the month unless otherwise stated. Agenda to be posted at [here]({% link meetings/template.md %}).
...
Peter F shared the zigi project ( [https://zigi.rocks/](https://zigi.rocks/) ), which many in the group liked. John M said he would follow up with the project leads to see if they want to present at a future meeting.
